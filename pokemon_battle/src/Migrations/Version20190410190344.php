 ...
 */
final class Version20190410190344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipe_pokemon CHANGE surnom surnon VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipe_pokemon CHANGE surnon surnom VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
